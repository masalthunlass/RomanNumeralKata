...
describe('convert to Roman Numeral  should', () => {
    ...
    test('gives L output for 50 as input', () => {
        let romanNumeral = converter.convertToRomanNumeral(50);
    ...
    test('gives D output for 500 as input', () => {
        let romanNumeral = converter.convertToRomanNumeral(500);
    ...
    test('gives CM output for 900 as input', () => {
        let romanNumeral = converter.convertToRomanNumeral(900);
